        ...
        <main className="flex-1 w-full max-w-2xl mx-auto px-4 sm:px-6 py-8 sm:py-12 flex flex-col justify-center my-auto">
          ...
          <div className="space-y-6 text-[var(--text-primary)]/90 text-sm leading-relaxed">
            ...
            <section className="space-y-2">
              ...
              <BodyText>
                Profile preferences and companion memories sync securely to your account via our cloud database, allowing them to carry over across sessions and devices. Your actual message and conversation history is stored ephemerally on your device and browser only. It is automatically wiped upon logout and will not transfer if you switch devices or clear your browser data.
              </BodyText>
            </section>
