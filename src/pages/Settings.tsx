            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-8 mb-5 sm:mb-8">
              <div className="space-y-2">
                ...
                <input 
                  ...
                  autoComplete="name"
                  className="w-full h-11 px-4 rounded-xl text-sm font-medium bg-[var(--bg-base)] border border-[var(--text-primary)]/12 hover:border-[var(--accent-primary)]/35 focus:border-[var(--accent-primary)]/50 focus:outline-none text-[var(--text-primary)] placeholder:text-[var(--text-muted)]/50 transition-all disabled:opacity-50"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <input 
                  ...
                  readOnly
                  disabled 
                  className="w-full h-11 px-4 rounded-xl text-sm font-medium bg-[var(--bg-base)]/60 border border-[var(--text-primary)]/12 text-[var(--text-muted)] cursor-not-allowed opacity-75"
                />
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-4 mb-5 sm:mb-8">
            <div className="flex items-start gap-3 sm:gap-4 w-full">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between gap-2 sm:justify-start sm:gap-3 w-full">
                  <h2 className="font-heading font-semibold text-lg sm:text-2xl text-[var(--text-primary)] leading-tight">What She Remembers</h2>
                  {memories.length > 0 && (
                    <span className="text-xs font-semibold text-[var(--accent-primary)] bg-[var(--accent-primary)]/10 px-2.5 py-0.5 sm:px-3 sm:py-1 rounded-full border border-[var(--accent-primary)]/15 inline-flex items-center gap-1.5 shrink-0 ml-auto sm:ml-0">
