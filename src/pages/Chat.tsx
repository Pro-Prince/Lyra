  ...
  return (
    <div className="chat-layout chat-page-container w-full h-[100dvh] md:h-[calc(100vh-56px)] bg-[#0b0a12] flex flex-col md:flex-row font-body overflow-hidden" style={{ '--accent': activeAccent } as React.CSSProperties}>
        ...
        {isMobile ? (
          ...
          <div className="absolute bottom-0 left-0 right-0 z-40 pointer-events-none flex flex-col items-center justify-end bg-gradient-to-t from-[#160f17] via-[#160f17]/40 to-transparent pt-12 pb-0">
            {/* Control Bar - Floating slightly above the bottom handle */}
            <div className="pointer-events-auto w-full pb-10 flex justify-center">
              <ControlBar
                isListening={isListening}
