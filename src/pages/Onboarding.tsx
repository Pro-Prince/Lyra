...
export default function Onboarding() {
  ...
  return (
    <motion.div 
      ...
      className="relative min-h-screen w-full bg-[var(--bg-base)] text-[var(--text-primary)] font-body flex flex-col justify-center items-center overflow-x-hidden select-none"
    >
      ...
      <main className={`relative z-10 w-full ${step === 6 ? 'max-w-3xl lg:max-w-4xl' : 'max-w-xl'} mx-auto px-4 sm:px-6 pt-16 sm:pt-20 pb-12 sm:pb-8 flex-1 flex flex-col justify-center items-center transition-all duration-300`}>
