...
export function RoomEnvironment() {
  return (
    <group>
      ...
      <ambientLight intensity={2.5} color="#FFF0F5" />
      {/* Front-right key directional light */}
      <directionalLight position={[1.5, 3.5, 2.5]} intensity={1.5} color="#FFF6EE" />
      {/* Soft fill light from front-left */}
      <directionalLight position={[-2.0, 2.5, 2.0]} intensity={0.8} color="#F5E8FF" />
