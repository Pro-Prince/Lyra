  ...
  return (
    <div className="control-bar z-20 flex items-center justify-center gap-5 sm:gap-6 w-full px-2 md:px-4">
      ...
      <button
        ...
        className={`w-16 h-16 sm:w-18 sm:h-18 rounded-full border flex items-center justify-center transition-all duration-300 cursor-pointer active:scale-95 shrink-0 ${
          isPortraitMode
      ...
      <div className="relative flex items-center justify-center">
        ...
        <button
          ...
          className={`relative z-10 w-16 h-16 sm:w-18 sm:h-18 rounded-full border flex items-center justify-center transition-all duration-300 cursor-pointer active:scale-95 shrink-0 ${
            isVoiceActive
