...
export default function Footer() {
  ...
  return (
    <footer className="app-footer w-full bg-[var(--bg-surface)] pt-10 sm:pt-16 pb-10 sm:pb-12 font-body mt-auto relative z-10 border-t border-[var(--text-muted)]/15">
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        {/* Responsive Grid: 2-column on mobile (Brand full width, Product + Support side-by-side), 12-column on desktop */}
        <div className="footer-columns grid grid-cols-2 md:grid-cols-12 gap-y-8 md:gap-y-8 gap-x-6 sm:gap-8 mb-8 sm:mb-12">
          ...
          <div className="footer-column col-span-2 md:col-span-6 flex flex-col items-start pr-0 md:pr-4">
            <Link 
              to="/" 
              className="footer-brand flex items-center gap-2 sm:gap-3 mb-2.5 sm:mb-3.5 group cursor-pointer transition-transform active:scale-95"
            ...
            <p className="text-[var(--text-muted)] text-[12.5px] sm:text-[14px] leading-relaxed max-w-sm">
          ...
          <div className="footer-column col-span-1 md:col-span-3 flex flex-col items-start min-w-0">
            <span className="text-[10px] sm:text-[11px] font-semibold uppercase tracking-wider text-[var(--accent-primary)] mb-2.5 sm:mb-2.5 block">
              PRODUCT
            </span>
            <div className="footer-links-group w-full">
              <FooterAnchorLink
                to="features"
                className="footer-link text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors cursor-pointer block whitespace-nowrap"
              >
                Features
              </FooterAnchorLink>
              <FooterAnchorLink
          ...
          <div className="footer-column col-span-1 md:col-span-3 flex flex-col items-start min-w-0">
            ...
            <div className="footer-links-group w-full">
              <Link
                to="/contact"
                className="footer-link text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors block whitespace-nowrap"
              >
                Contact Us
              </Link>
              <Link
        ...
        <div className="flex flex-col-reverse items-center justify-center gap-3 sm:flex-row sm:justify-between text-[11px] sm:text-[13px] text-[var(--text-muted)] text-center sm:text-left">
          <div>
