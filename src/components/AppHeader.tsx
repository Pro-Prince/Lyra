...
export default function AppHeader() {
  ...
  return (
    <>
      <header className="fixed top-0 left-0 right-0 z-50 w-full h-14 bg-[var(--bg-surface)]/95 backdrop-blur-md border-b border-[var(--text-muted)]/15 px-4 sm:px-8 flex items-center justify-between shadow-sm">
        {/* BRAND / LOGO */}
        <Link
          to="/"
